    ...
    <b-row align-v="center" lg>
      <b-col cols="12" lg="4">
        <elsa-search-input
          ...
          :placeholder="$t('hae-kouluttajan-nimella')"
        />
      </b-col>
      <b-col cols="12" lg="4">
...
<script lang="ts">
  ...
  import { getKouluttajat } from '@/api/kayttajahallinta'
  ...
  export default class Kouluttajat extends Mixins(KayttajahallintaListMixin) {
    async mounted() {
      this.loading = true
      try {
        await this.fetch()
