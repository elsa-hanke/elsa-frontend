...
<script lang="ts">
  ...
  import { postVastuuhenkilo, getVastuuhenkiloLomake } from '@/api/kayttajahallinta'
  ...
  export default class VastuuhenkiloForm extends Mixins(validationMixin) {
    ...
    vastuuhenkiloLomake: null | VastuuhenkiloLomake = null
    loading = true
    saving = false

    async mounted() {
      this.vastuuhenkiloLomake = (await getVastuuhenkiloLomake()).data
    ...
    get yliopistot() {
      return this.vastuuhenkiloLomake?.yliopistot ?? []
    }
  }
</script>
