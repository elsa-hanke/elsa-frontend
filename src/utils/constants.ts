...
export enum ValmistumispyynnonTila {
  UUSI = 'UUSI',
  ODOTTAA_VASTUUHENKILON_TARKISTUSTA = 'ODOTTAA_VASTUUHENKILON_TARKISTUSTA',
  VASTUUHENKILON_TARKISTUS_PALAUTETTU = 'VASTUUHENKILON_TARKISTUS_PALAUTETTU',
  ODOTTAA_VIRKAILIJAN_TARKISTUSTA = 'ODOTTAA_VIRKAILIJAN_TARKISTUSTA',
  VIRKAILIJAN_TARKISTUS_PALAUTETTU = 'VIRKAILIJAN_TARKISTUS_PALAUTETTU',
  ODOTTAA_VASTUUHENKILON_HYVAKSYNTAA = 'ODOTTAA_VASTUUHENKILON_HYVAKSYNTAA',
